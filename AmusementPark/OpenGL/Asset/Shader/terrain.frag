...
void main()
{
    ...
    vec3 result = CalcDirLight(dirLight, vec3(texture(tex, f_in.texture_coordinate)), f_in.normal, viewDir);
	result += CalcSpotLight(spotLight, vec3(texture(tex, f_in.texture_coordinate)), f_in.normal, f_in.position, viewDir);
